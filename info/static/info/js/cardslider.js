!(function () {
    ...
    const L = (e, t) => {
        ...
        I = (e) => {
            ...
            else for (let i = Math.max(r - t, 0); i <= Math.min(r + t, s - 1); i += 1) i !== a && i > r && k(e, i);
        };
    var O = {
        updateSize: function () {
            const e = this;
        ...
        updateSlides: function () {
            ...
            let A = i.spaceBetween,
                ...
                C = 0;
            if (void 0 === n) return;
            "string" == typeof A && A.indexOf("%") >= 0 ? (A = (parseFloat(A.replace("%", "")) / 100) * n) : "string" == typeof A && (A = parseFloat(A)),
                (e.virtualSize = -A),
                c.forEach((e) => {
                    l ? (e.style.marginLeft = "") : (e.style.marginRight = ""), (e.style.marginBottom = ""), (e.style.marginTop = "");
                }),
                i.centeredSlides && i.cssMode && (u(a, "--swiper-centered-offset-before", ""), u(a, "--swiper-centered-offset-after", ""));
            ...
            for (let a = 0; a < m; a += 1) {
                let r;
                if (((z = 0), c[a] && (r = c[a]), P && e.grid.updateSlide(a, r, m, t), !c[a] || "none" !== w(r, "display"))) {
                    if ("auto" === i.slidesPerView) {
                        L && (c[a].style[t("width")] = "");
                        const n = getComputedStyle(r),
                            l = r.style.transform,
                            o = r.style.webkitTransform;
                        if ((l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), i.roundLengths)) z = e.isHorizontal() ? E(r, "width", !0) : E(r, "height", !0);
                        else {
                            const e = s(n, "width"),
                                t = s(n, "padding-left"),
                                i = s(n, "padding-right"),
                        ...
                        l && (r.style.transform = l), o && (r.style.webkitTransform = o), i.roundLengths && (z = Math.floor(z));
                    } else (z = (n - (i.slidesPerView - 1) * A) / i.slidesPerView), i.roundLengths && (z = Math.floor(z)), c[a] && (c[a].style[t("width")] = `${z}px`);
                    c[a] && (c[a].swiperSlideSize = z),
                        ...
                        i.centeredSlides
                            ? ((T = T + z / 2 + M / 2 + A),
                              ...
                              g.push(T))
                            : (i.roundLengths && (T = Math.floor(T)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && h.push(T), g.push(T), (T = T + z + A)),
                        (e.virtualSize += z + A),
                        (M = z),
                        (C += 1);
                }
            ...
            if (
                ...
                l && o && ("slide" === i.effect || "coverflow" === i.effect) && (a.style.width = `${e.virtualSize + A}px`),
                ...
                for (let s = 0; s < h.length; s += 1) {
                    let a = h[s];
                    i.roundLengths && (a = Math.floor(a)), h[s] <= e.virtualSize - n && t.push(a);
                }
            ...
            if (d && i.loop) {
                ...
                for (let s = 0; s < e.virtual.slidesBefore + e.virtual.slidesAfter; s += 1) 1 === i.slidesPerGroup && h.push(h[h.length - 1] + t), g.push(g[g.length - 1] + t), (e.virtualSize += t);
            }
            ...
            if ((Object.assign(e, { slides: c, snapGrid: h, slidesGrid: g, slidesSizesGrid: v }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                u(a, "--swiper-centered-offset-before", -h[0] + "px"), u(a, "--swiper-centered-offset-after", e.size / 2 - v[v.length - 1] / 2 + "px");
            ...
            if (
                ...
                h.length !== x && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")),
        ...
        updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                ((u >= 0 && u < t.size - 1) || (m > 1 && m <= t.size) || (u <= 0 && m >= t.size)) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)),
                    (o.progress = a ? -p : p),
        ...
        updateActiveIndex: function (e) {
            ...
            let c;
            (c = t.virtual && a.virtual.enabled && a.loop ? p(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d),
                Object.assign(t, { previousSnapIndex: l, snapIndex: o, previousRealIndex: n, realIndex: c, previousIndex: r, activeIndex: d }),
                t.initialized && I(t),
    ...
    var B = {
        slideTo: function (e, t, s, i, a) {
            ...
            let b;
            if ((n !== (p || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(w), (b = n > c ? "next" : n < c ? "prev" : "reset"), (u && -w === r.translate) || (!u && w === r.translate)))
        ...
        slidePrev: function (e, t, s) {
            ...
            if (
                (void 0 !== h &&
                    ((f = n.indexOf(h)), f < 0 && (f = i.activeIndex - 1), "auto" === a.slidesPerView && 1 === a.slidesPerGroup && a.slidesPerGroupAuto && ((f = f - i.slidesPerViewDynamic("previous", !0) + 1), (f = Math.max(f, 0)))),
            ...
            if (
                ...
                if (g.length > 0 && y)
                    if (void 0 === t) {
                        ...
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(w + x, 0, !1, !0), a && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t));
                    } else a && o.slideToLoop(t, 0, !1, !0);
                else if (v.length > 0 && b)
                    if (void 0 === t) {
                        const e = o.slidesGrid[w],
                            t = o.slidesGrid[w - E] - e;
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(w - E, 0, !1, !0), a && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t));
                    } else o.slideToLoop(t, 0, !1, !0);
            if (((o.allowSlidePrev = p), (o.allowSlideNext = c), o.controller && o.controller.control && !n)) {
                const e = { slideRealIndex: t, slideTo: !1, direction: i, setTranslate: a, activeSlideIndex: r, byController: !0 };
    ...
    function Y(e) {
        ...
        (!o.touchStartForcePreventDefault && !E) || u.isContentEditable || c.preventDefault(), t.params.freeMode && t.params.freeMode.enabled && t.freeMode && t.animating && !o.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", c);
    }
    function H(e) {
        const t = i(),
            s = this,
        ...
        if (!s.allowTouchMove)
            return (
                ...
                void (a.isTouched && (Object.assign(n, { startX: m, startY: h, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: m, currentY: h }), (a.touchStartTime = l())))
            );
        ...
        if (void 0 === a.isScrolling) {
            ...
            (s.isHorizontal() && n.currentY === n.startY) || (s.isVertical() && n.currentX === n.startX)
                ? (a.isScrolling = !1)
                : f * f + g * g >= 25 && ((e = (180 * Math.atan2(Math.abs(g), Math.abs(f))) / Math.PI), (a.isScrolling = s.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
        }
        if (
        ...
        let x;
        a.isMoved && b !== s.touchesDirection && y && Math.abs(v) >= 1 && (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (x = !0)), s.emit("sliderMove", p), (a.isMoved = !0), (a.currentTranslate = v + a.startTranslate);
        let E = !0,
            S = r.resistanceRatio;
        if (
            (r.touchReleaseOnEdges && (S = 0),
            v > 0
                ? (y && !x && a.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
                  a.currentTranslate > s.minTranslate() && ((E = !1), r.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + v) ** S)))
                : v < 0 &&
                  (y &&
                      !x &&
                      a.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) &&
                  ...
                  a.currentTranslate < s.maxTranslate() && ((E = !1), r.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - v) ** S))),
    ...
    function _(e) {
        ...
        const { params: a, touches: r, rtlTranslate: o, slidesGrid: d, enabled: p } = t;
        if (!p) return;
        ...
        let v = null,
            w = null;
        a.rewind && (t.isBeginning ? (w = t.params.virtual && t.params.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1) : t.isEnd && (v = 0));
        const b = (h - d[f]) / g,
            y = f < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
        if (m > a.longSwipesMs) {
            if (!a.longSwipes) return void t.slideTo(t.activeIndex);
            "next" === t.swipeDirection && (b >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? v : f + y) : t.slideTo(f)),
                "prev" === t.swipeDirection && (b > 1 - a.longSwipesRatio ? t.slideTo(f + y) : null !== w && b < 0 && Math.abs(b) > a.longSwipesRatio ? t.slideTo(w) : t.slideTo(f));
        } else {
    ...
    const V = (e, t) => {
        ...
        r[d]("pointerdown", e.onTouchStart, { passive: !1 }),
            ...
            a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : e[p]("observerUpdate", N, !0),
        ...
        return function (s) {
            ...
            "object" == typeof a && null !== a
                ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }),
                  i in e && "enabled" in a ? (!0 === e[i] && (e[i] = { enabled: !0 }), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), c(t, s)) : c(t, s))
                : c(t, s);
        };
    }
    const Z = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    const s = this,
                        { params: i } = s;
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), D({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
                },
                transitionEnd: function (e, t) {
                    void 0 === e && (e = !0);
                    const s = this,
                        { params: i } = s;
                    (s.animating = !1), i.cssMode || (s.setTransition(0), D({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: B,
            loop: G,
        ...
        return (
            e.params.createElements &&
                Object.keys(i).forEach((a) => {
                    if (!s[a] && !0 === s.auto) {
                        let r = f(e.el, `.${i[a]}`)[0];
                        r || ((r = g("div", i[a])), (r.className = i[a]), e.el.append(r)), (s[a] = r), (t[a] = r);
                    }
                }),
            s
        );
    ...
    function pe(e, t, s) {
        ...
        return r || ((r = g("div", "swiper-slide-shadow" + (s ? `-${s}` : ""))), a.append(r)), r;
    }
    ...
    const ce = [
        function (e) {
            ...
            function d(e, t) {
                ...
                let a;
                return (
                    i.renderSlide ? ((a = i.renderSlide.call(s, e, t)), "string" == typeof a && ((o.innerHTML = a), (a = o.children[0]))) : (a = s.isElement ? g("swiper-slide") : g("div", s.params.slideClass)),
            ...
            function p(e) {
                ...
                if (
                    (r && g >= b ? ((y -= b), a || (E += s.slidesGrid[0])) : r && g < b && ((y = -b), a && (E += s.slidesGrid[0])),
                    Object.assign(s.virtual, { from: y, to: x, offset: E, slidesGrid: s.slidesGrid, slidesBefore: b, slidesAfter: w }),
                    p === y && c === x && !e)
                )
                    return (
                        s.slidesGrid !== m &&
                ...
                for (let t = C; t < P; t += 1)
                    if (t >= y && t <= x) {
                        const s = M(t);
                        void 0 === c || e ? T.push(s) : (t > c && T.push(s), t < p && A.push(s));
                    }
                if (
                    (T.forEach((e) => {
        ...
        function (e) {
            ...
            function d(e) {
                ...
                if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || (l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase())))) {
                    ...
                    t.isHorizontal()
                        ? ((d || p || c || u) && (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)), (((p || u) && !s) || ((d || c) && s)) && t.slideNext(), (((d || c) && !s) || ((p || u) && s)) && t.slidePrev())
                        : ((d || p || m || h) && (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)), (p || h) && t.slideNext(), (d || m) && t.slidePrev()),
                        n("keyPress", a);
                }
            }
            function p() {
        ...
        function (e) {
            ...
            function f(e) {
                return (
                    ...
                    !(t.params.mousewheel.thresholdTime && l() - c < t.params.mousewheel.thresholdTime) &&
                    ((e.delta >= 6 && l() - c < 60) ||
            ...
            function g(e) {
                ...
                if (
                    ...
                    if (!i) {
                        ...
                        if ((i || a("scroll", s), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), l === t.minTranslate() || l === t.maxTranslate())) return !0;
                    }
                } else {
        ...
        function (e) {
            ...
            function c(e) {
                ...
                if (t.params.loop) {
                    ...
                    e > t.slides.length - t.loopedSlides && t.loopFix({ direction: e > s ? "next" : "prev", activeSlideIndex: e, slideTo: !1 }), t.slideToLoop(i);
                } else t.slideTo(i);
            }
            function u() {
                const e = t.rtl,
                    ...
                    if (
                        ...
                        a.forEach((e) => {
                            ...
                            t === i && e.classList.add(...s.bulletActiveClass.split(" ")),
                                s.dynamicBullets && (t >= o && t <= d && e.classList.add(...`${s.bulletActiveClass}-main`.split(" ")), t === o && p(e, "prev"), t === d && p(e, "next"));
                        });
                    else {
                        const e = a[i];
            ...
            function f() {
                ...
                s &&
                    ((s = o(s)),
                    s.forEach((s) => {
                        s.classList.remove(e.hiddenClass), s.classList.remove(e.modifierClass + e.type), s.classList.remove(t.isHorizontal() ? e.horizontalClass : e.verticalClass), e.clickable && s.removeEventListener("click", c);
                    })),
        ...
        function (e) {
            ...
            function f() {
                ...
                let l = d,
                    o = (p - d) * n;
                s ? ((o = -o), o > 0 ? ((l = d - o), (o = 0)) : -o + d > p && (l = p + o)) : o < 0 ? ((l = d + o), (o = 0)) : o + d > p && (l = p - o),
            ...
            function w() {
                ...
                (s.style.width = ""),
                    ...
                    (d = "auto" === t.params.scrollbar.dragSize ? p * c : parseInt(t.params.scrollbar.dragSize, 10)),
            ...
            function y(e) {
                const { scrollbar: s, rtlTranslate: i } = t,
                    { el: a } = s;
                let r;
                (r = (b(e) - v(a)[t.isHorizontal() ? "left" : "top"] - (null !== o ? o : d / 2)) / (p - d)), (r = Math.max(Math.min(r, 1), 0)), i && (r = 1 - r);
            ...
            function T() {
                ...
                if (!i.el) return;
                let a, r;
                "string" == typeof i.el && t.isElement && (a = t.el.shadowRoot.querySelector(i.el)),
                    ...
                    a && ((r = a.querySelector(`.${t.params.scrollbar.dragClass}`)), r || ((r = g("div", t.params.scrollbar.dragClass)), a.append(r))),
            ...
            function M() {
                const e = t.params.scrollbar,
                    s = t.scrollbar.el;
                s && s.classList.remove(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.params.scrollbar.el && t.scrollbar.el && A("off");
            }
            s({
                scrollbar: {
                    el: null,
            ...
            Object.assign(t.scrollbar, {
                enable: () => {
                    t.el.classList.remove(t.params.scrollbar.scrollbarDisabledClass), t.scrollbar.el && t.scrollbar.el.classList.remove(t.params.scrollbar.scrollbarDisabledClass), T(), w(), f();
                },
                disable: C,
                updateSize: w,
                setTranslate: f,
            ...
            const a = (e, s) => {
                ...
                r = () => {
                    ...
                    f(e, "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").forEach((e) => {
                        ...
                        s.forEach((e, s) => {
                            let n = e.progress;
                            t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (n += Math.ceil(s / 2) - i * (r.length - 1)),
        ...
        function (e) {
            ...
            function E(e) {
                ...
                if (((l = !1), (d = !1), u.push(e), !(u.length < 2))) {
                    if (((l = !0), (m.scaleStart = b()), !m.slideEl)) {
                        ...
                        if ((i && (i = i.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (m.imageEl = i), (m.imageWrapEl = i ? y(m.imageEl, `.${s.containerClass}`)[0] : void 0), !m.imageWrapEl))
            ...
            function C(e) {
                ...
                if (!m.slideEl) {
                    ...
                    s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (m.imageEl = s), (m.imageWrapEl = s ? y(m.imageEl, `.${i.containerClass}`)[0] : void 0);
                }
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                Object.assign(t.zoom, { enable: k, disable: I, in: C, out: P, toggle: z });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: i } = e;
            function a(e, t) {
            ...
            s({ controller: { control: void 0, inverse: !1, by: "slide" } }),
                ...
                Object.assign(t.controller, {
                    ...
                    setTransition: function (e, s) {
                        ...
                        if (Array.isArray(a)) for (r = 0; r < a.length; r += 1) a[r] !== s && a[r] instanceof i && l(a[r]);
        ...
        function (e) {
            ...
            function h(e) {
                ...
                const s = t.params.a11y,
                    i = e.target;
                (t.pagination && t.pagination.el && (i === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(te(t.params.pagination.bulletClass))) ||
                    ...
                    t.pagination && i.matches(te(t.params.pagination.bulletClass)) && i.click());
            }
            function f() {
            ...
            i("beforeInit", () => {
                (a = g("span", t.params.a11y.notificationClass)), a.setAttribute("aria-live", "assertive"), a.setAttribute("aria-atomic", "true");
            }),
                i("afterInit", () => {
                        ...
                        (function () {
                            ...
                            f() &&
                                t.pagination.bullets.forEach((s) => {
                                    t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, b(s) + 1)))),
                ...
                t.params.history.enabled &&
                    (() => {
                        ...
                        if (t.params.history) {
                            ...
                            (a = !0),
                                (n = o(t.params.url)),
                                n.key || n.value ? (p(0, n.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", c)) : t.params.history.replaceState || e.addEventListener("popstate", c);
                        }
                    })();
            }),
                i("destroy", () => {
        ...
        function (e) {
            ...
            (a.autoplay = { running: !1, paused: !1, timeLeft: 0 }), r({ autoplay: { enabled: !1, delay: 3e3, waitForTransition: !0, disableOnInteraction: !0, stopOnLastSlide: !1, reverseDirection: !1, pauseOnMouseEnter: !1 } });
            let d,
                p,
                c,
                u,
                ...
                w = new Date().getTime;
            function b(e) {
                a && !a.destroyed && a.wrapperEl && e.target === a.wrapperEl && (a.wrapperEl.removeEventListener("transitionend", b), T());
            }
            const y = () => {
                ...
                A = (e, s) => {
                    ...
                    const i = () => {
                        l("autoplayPause"), a.params.autoplay.waitForTransition ? a.wrapperEl.addEventListener("transitionend", b) : T();
                    };
                ...
                M = () => {
                    if (a.destroyed || !a.autoplay.running) return;
                    const e = i();
                    "hidden" === e.visibilityState && ((f = !0), A(!0)), "visible" === e.visibilityState && T();
                },
                C = (e) => {
            ...
            n("init", () => {
                a.params.autoplay.enabled &&
                    (a.params.autoplay.pauseOnMouseEnter && (a.el.addEventListener("pointerenter", C), a.el.addEventListener("pointerleave", P)), i().addEventListener("visibilitychange", M), (w = new Date().getTime()), E());
            }),
                n("destroy", () => {
                    a.el.removeEventListener("pointerenter", C), a.el.removeEventListener("pointerleave", P), i().removeEventListener("visibilitychange", M), a.autoplay.running && S();
                }),
                n("beforeTransitionStart", (e, t, s) => {
                    !a.destroyed && a.autoplay.running && (s || !a.params.autoplay.disableOnInteraction ? A(!0, !0) : S());
                }),
                n("sliderFirstMove", () => {
                    !a.destroyed &&
                        a.autoplay.running &&
                ...
                Object.assign(t, {
                    freeMode: {
                        ...
                        onTouchEnd: function (e) {
                            let { currentPos: s } = e;
                            const { params: r, wrapperEl: n, rtlTranslate: o, snapGrid: d, touchEventsData: p } = t,
                            ...
                            if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                                ...
                                if (r.freeMode.momentum) {
                                    ...
                                    let f;
                                    if (c < t.maxTranslate())
                                        r.freeMode.momentumBounce ? (c + t.maxTranslate() < -h && (c = t.maxTranslate() - h), (u = t.maxTranslate()), (m = !0), (p.allowMomentumBounce = !0)) : (c = t.maxTranslate()),
                                            r.loop && r.centeredSlides && (f = !0);
                                    else if (c > t.minTranslate())
                                        r.freeMode.momentumBounce ? (c - t.minTranslate() > h && (c = t.minTranslate() + h), (u = t.minTranslate()), (m = !0), (p.allowMomentumBounce = !0)) : (c = t.minTranslate()),
                                            r.loop && r.centeredSlides && (f = !0);
        ...
        function (e) {
            ...
            a.grid = {
                initSlides: (e) => {
                    ...
                    (s = t / n), (i = Math.floor(e / n)), (t = Math.floor(e / n) === e / n ? e : Math.ceil(e / n) * n), "auto" !== r && "row" === l && (t = Math.max(t, r * n));
                },
                updateSlide: (e, r, l, o) => {
        ...
        function (e) {
            let { swiper: t } = e;
            Object.assign(t, { appendSlide: se.bind(t), prependSlide: ie.bind(t), addSlide: ae.bind(t), removeSlide: re.bind(t), removeAllSlides: ne.bind(t) });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: i } = e;
        ...
        function (e) {
            ...
            const a = (e, t, s) => {
                ...
                i || ((i = g("div", "swiper-slide-shadow-" + (s ? "left" : "top"))), e.append(i)),
                    a || ((a = g("div", "swiper-slide-shadow-" + (s ? "right" : "bottom"))), e.append(a)),
        ...
        function (e) {
            ...
            const a = (e, s, i) => {
                ...
                a || (a = pe(0, e, t.isHorizontal() ? "left" : "top")), r || (r = pe(0, e, t.isHorizontal() ? "right" : "bottom")), a && (a.style.opacity = Math.max(-s, 0)), r && (r.style.opacity = Math.max(s, 0));
            };
            le({
                effect: "flip",
                swiper: t,
                ...
                le({
                    ...
                    setTranslate: () => {
                        ...
                        for (let e = 0, t = i.length; e < t; e += 1) {
                            ...
                            if (((oe(0, t).style.transform = b), (t.style.zIndex = 1 - Math.abs(Math.round(c))), r.slideShadows)) {
                                let e = n ? t.querySelector(".swiper-slide-shadow-left") : t.querySelector(".swiper-slide-shadow-top"),
                                    s = n ? t.querySelector(".swiper-slide-shadow-right") : t.querySelector(".swiper-slide-shadow-bottom");
                                e || (e = pe(0, t, n ? "left" : "top")), s || (s = pe(0, t, n ? "right" : "bottom")), e && (e.style.opacity = c > 0 ? c : 0), s && (s.style.opacity = -c > 0 ? -c : 0);
                            }
                        }
                    },
                    setTransition: (e) => {
                ...
                le({
                    ...
                    setTranslate: () => {
                        ...
                        for (let l = 0; l < e.length; l += 1) {
                            ...
                            t.params.centeredSlides && !t.params.cssMode && (t.wrapperEl.style.transform = `translateX(${t.minTranslate()}px)`), t.params.centeredSlides && t.params.cssMode && (c -= e[0].swiperSlideOffset);
                            ...
                            const w = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l,
                                b = (w === s || w === s - 1) && p > 0 && p < 1 && (r || t.params.cssMode) && n < a,
                                y = (w === s || w === s + 1) && p < 0 && p > -1 && (r || t.params.cssMode) && n > a;
                            if (b || y) {
                                const e = (1 - Math.abs((Math.abs(p) - 0.5) / 0.5)) ** 0.5;
                                (g += -28 * p * e), (f += -0.5 * e), (v += 96 * e), (m = -25 * e * Math.abs(p) + "%");
                            }
                            if (((u = p < 0 ? `calc(${u}px + (${v * Math.abs(p)}%))` : p > 0 ? `calc(${u}px + (-${v * Math.abs(p)}%))` : `${u}px`), !t.isHorizontal())) {
                                const e = m;
                                (m = u), (u = e);
                            }
                            ...
                            if (i.slideShadows) {
                                ...
                                e || (e = pe(0, o)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - 0.5) / 0.5, 0), 1));
                            }
    ...
    function he(e, t) {
        ...
        Object.keys(t)
            ...
            .forEach((s) => {
                void 0 === e[s] ? (e[s] = t[s]) : me(t[s]) && me(e[s]) && Object.keys(t[s]).length > 0 ? (t[s].__swiper__ ? (e[s] = t[s]) : he(e[s], t[s])) : (e[s] = t[s]);
            });
    }
    function fe(e) {
        return void 0 === e && (e = ""), e.replace(/-[a-z]/g, (e) => e.toUpperCase().replace("-", ""));
    }
    const ge = (e) => (parseFloat(e) === Number(e) ? Number(e) : "true" === e || "" === e || ("false" !== e && ("null" === e ? null : "undefined" !== e ? e : void 0))),
        ve = [
            "a11y",
            "autoplay",
            "controller",
        ...
        return (
            ...
            [...e.attributes].forEach((e) => {
                ...
                if (t) {
                    ...
                    s[i] || (s[i] = {}), !0 === s[i] && (s[i] = { enabled: !0 }), (s[i][a] = ge(e.value));
                } else {
                    const t = fe(e.name);
                    if (!a.includes(t)) return;
                    const i = ge(e.value);
                    s[t] && ve.includes(e.name) ? (s[t].constructor !== Object && (s[t] = {}), (s[t].enabled = i)) : (s[t] = i);
                }
            }),
            he(t, s),
            t.navigation ? (t.navigation = { prevEl: ".swiper-button-prev", nextEl: ".swiper-button-next", ...(!0 !== t.navigation ? t.navigation : {}) }) : !1 === t.navigation && delete t.navigation,
            t.scrollbar ? (t.scrollbar = { el: ".swiper-scrollbar", ...(!0 !== t.scrollbar ? t.scrollbar : {}) }) : !1 === t.scrollbar && delete t.scrollbar,
            t.pagination ? (t.pagination = { el: ".swiper-pagination", ...(!0 !== t.pagination ? t.pagination : {}) }) : !1 === t.pagination && delete t.pagination,
    ...
    function be(e) {
        ...
        if (
            ...
            d.forEach((e) => {
                if (me(p[e]) && me(i[e])) he(p[e], i[e]);
                    ...
                    const a = i[e];
                    (!0 !== a && !1 !== a) || ("navigation" !== e && "pagination" !== e && "scrollbar" !== e)
                        ? (p[e] = i[e])
                        : !1 === a &&
                          t[(s = e)] &&
                          (t[s].destroy(),
                          "navigation" === s
                              ? (t.isElement && (t[s].prevEl.remove(), t[s].nextEl.remove()), (p[s].prevEl = void 0), (p[s].nextEl = void 0), (t[s].prevEl = void 0), (t[s].nextEl = void 0))
                              : (t.isElement && t[s].el.remove(), (p[s].el = void 0), (t[s].el = void 0)));
                }
                var s;
            }),
            ...
            a.includes("children") && s && h && p.virtual.enabled && ((h.slides = s), h.update(!0)),
        ...
        v && (t.controller.control = p.controller.control),
            w && (!t.isElement || (o && "string" != typeof o) || ((o = document.createElement("div")), o.classList.add("swiper-pagination"), t.el.shadowEl.appendChild(o)), o && (p.pagination.el = o), c.init(), c.render(), c.update()),
            b &&
                (!t.isElement || (l && "string" != typeof l) || ((l = document.createElement("div")), l.classList.add("swiper-scrollbar"), t.el.shadowEl.appendChild(l)),
                l && (p.scrollbar.el = l),
                m.init(),
                m.updateSize(),
                m.setTranslate()),
            y &&
                (t.isElement &&
                    ((r && "string" != typeof r) || ((r = document.createElement("div")), r.classList.add("swiper-button-next"), t.el.shadowEl.appendChild(r)),
                    (n && "string" != typeof n) || ((n = document.createElement("div")), n.classList.add("swiper-button-prev"), t.el.shadowEl.appendChild(n))),
    ...
    const Ee = (e, t) => {
        ...
        !e &&
            ...
            (s && !i) || ((s = s || document.createElement("style")), (s.textContent = [ye, t ? t.cssStyles() : ""].join("\n")), (s.id = "swiper-element-styles"), (s.preInit = e), document.head.prepend(s));
    };
    const Se = "undefined" == typeof window || "undefined" == typeof HTMLElement ? class {} : HTMLElement;
    class Ae extends Se {
        constructor() {
        ...
        render() {
            ...
            var t;
            e.length && ((this.stylesEl = document.createElement("style")), (this.stylesEl.textContent = e), this.shadowEl.appendChild(this.stylesEl)),
                ...
                (this.tempDiv.innerHTML = `\n      <slot name="container-start"></slot>\n      <div class="swiper-wrapper">\n        <slot></slot>\n      </div>\n      <slot name="container-end"></slot>\n      ${
                    ((t = this.passedParams),
                    void 0 === t && (t = {}),
                    t.navigation && void 0 === t.navigation.nextEl && void 0 === t.navigation.prevEl
        ...
        connectedCallback() {
            (this.initialized && this.nested && this.closest("swiper-slide") && this.closest("swiper-slide").swiperLoopMoveDOM) || (!1 !== this.init && "false" !== this.getAttribute("init") ? this.initialize() : Ee(!0, this));
        }
        ...
        updateSwiperOnPropChange(e) {
            ...
            (this.passedParams = s),
                ...
                be({
                    ...
                    changedParams: [fe(e)],
                    ...("navigation" === e && s[e] ? { prevEl: ".swiper-button-prev", nextEl: ".swiper-button-next" } : {}),
                    ...("pagination" === e && s[e] ? { paginationEl: ".swiper-pagination" } : {}),
                    ...("scrollbar" === e && s[e] ? { scrollbarEl: ".swiper-scrollbar" } : {}),
                });
        }
    ...
    "undefined" != typeof window &&
        ...
        "undefined" != typeof window &&
            (Me || (xe = !1),
            xe && Ee(!0),
            window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Ae),
            window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", Te));
})();
